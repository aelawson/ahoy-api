...
if args.cmd.lower() == "test":
    ...
    command = 'orator migrate:status -v -c ./src/services/db_config.py'
elif args.cmd.lower() == 'refresh':
    command = 'orator migrate:refresh -v -c ./src/services/db_config.py --seed'
elif args.cmd.lower() == 'rollback':
    command = 'orator migrate:reset -v -c ./src/services/db_config.py'
